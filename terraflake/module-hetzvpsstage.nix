...
in {
  ...
  networking = {
    ...
    interfaces = {
      eth0 = {
        ipv4.addresses = [
          { address="62.238.23.131"; prefixLength=32; }
        ];
        ipv6.addresses = [
          { address="2a01:4f9:c013:d8a2::1"; prefixLength=64; }
{ address="fe80::9000:8ff:fe59:bbef"; prefixLength=64; }
        ];
  ...
  services.udev.extraRules = ''
    ATTR{address}=="92:00:08:59:bb:ef", NAME="eth0"
